...
class SemsegModel(nn.Module):
    ...
    def forward(self, pyramid, target_size=(256, 512), image_size=(1024, 2048)):
    ...
    def prepare_data(self, batch, image_size, device=torch.device('cuda')):
        ...
        # print(f'pyramid length: {len(pyramid)}') # 1
        # print(f'image_size: {image_size}') # (1024, 2048)
        # print(f'pyramid: {pyramid[0].shape}') # torch.Size([1, 3, 1024, 2048])
        # print(f'batch: {batch}')
